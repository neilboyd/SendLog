...
public class LogcatThread implements Runnable {
    ...
    private boolean runProcess(final File pFile, final Process pProcess) throws IOException, InterruptedException {
        final BufferedWriter fileStream = new BufferedWriter(new FileWriter(pFile), SendLog.BUFFER_SIZE);
        ...
        Thread readerThread = new Thread() {
            ...
            public void run() {
                ...
                try {
                    reader = new BufferedReader(new InputStreamReader(pProcess.getInputStream()), SendLog.BUFFER_SIZE);
                    String line;
        ...
        Thread writerThread = new Thread() {
            ...
            public void run() {
                try {
                    for (String command : mSendLog.getCommands()) {
